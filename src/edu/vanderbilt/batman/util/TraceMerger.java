                ...
                if (type.equals("HTTP_SESSION")) {
                    ...
                    if (interaction != null) {
                        if (interaction.getResponse() != null) {
                            ...
                            if (print)
                                System.out.println("add interaction: " + interaction.getRequest().getRequestKey());
        ...
        if (output_stat) {
            ...
            for (WebSession session : sessions) {
                ...
                for (WebInteraction interaction : session.getInteractions()) {
                    if (interaction.getPreviousInteractions().isEmpty())
                        System.out.println("previous interactions not exist.");
